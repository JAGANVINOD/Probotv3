...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1455529478').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '827908943').split()]
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://jaganvinod123:jaganvinod123@cluster0.p6afdpp.mongodb.net/?retryWrites=true&w=majority&appName=AtlasApp")
